...
// Implementation-agnostic performances that test GoBGP operations
// These performances work on both critbitgo (old) and BART (new) implementations
...
// ============================================================================
// Performance: PrefixSet Operations (Policy)
// ============================================================================

func PerfCasePrefixSetCreation(b *testing.B) {
	scenarios := []struct {
		name   string
		count  int
		family bgp.Family
...
func PerfCasePrefixSetMerge(b *testing.B) {
	scenarios := []struct {
		name         string
		count        int
		collisionPct int
...
func PerfCasePrefixSetRemove(b *testing.B) {
	scenarios := []struct {
		name      string
		count     int
		removePct int
...
func PerfCasePrefixSetList(b *testing.B) {
	scenarios := []struct {
		name   string
		count  int
		family bgp.Family
...
// ============================================================================
// Performance: Policy Processing (Critical Path)
// ============================================================================

func PerfCasePolicyPrefixMatch(b *testing.B) {
	scenarios := []struct {
		name   string
		count  int
		family bgp.Family
...
func PerfCaseTableInsert(b *testing.B) {
	scenarios := []struct {
		name   string
		count  int
		family bgp.Family
...
func PerfCaseTableGetDestinations(b *testing.B) {
	scenarios := []struct {
		name   string
		count  int
		family bgp.Family
...
func PerfCaseTableGetLongerPrefixDestinations(b *testing.B) {
	scenarios := []struct {
		name      string
		count     int
		lookupKey string
...
// ============================================================================
// Performance: End-to-End Policy Application
// ============================================================================

func PerfCasePolicyApplicationComplete(b *testing.B) {
	// This performance simulates a complete policy processing cycle:
